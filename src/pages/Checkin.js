    ...
    return bonusPoints.map((points, index) => {
      ...
      return (
        ...
        >
          ...
          <span className='text-[13px] font-bold'>{formatNumber(points)}</span>
          ...
          <div id="refer" className='w-full flex flex-col scroller h-[100vh] overflow-y-auto pb-[180px] pt-3 px-4'>
            ...
            <div className={`w-full flex-col pb-4 flex items-center justify-center text-center pt-4`}>
              ...
              <p className='text-[14px] leading-[24px]'>
                Accrue ${process.env.REACT_APP_PROJECT_SYMBOL} tokens for logging into the game daily and maintain consistency for reward streaks!
              </p>
            </div>
          ...
          >
            <div className="w-full flex justify-center flex-col items-center space-y-3">
              ...
              <h3 className="font-medium text-[24px] text-[#ffffff] pb-2">
                {streak === true ? (
                  <>
                    <span className='text-accent'>+{formatNumber(bonusPoints[14])}</span> MAX
                  </>
                ) : (
                  <>
                    <span className='text-accent'>+{formatNumber(bonusPoints[checkInDays.length - 1])}</span> MAX
                  </>
