      ...
      <Animate>
        <div className="w-full pt-4 justify-center flex-col">
          ...
          <div className={`w-full flex items-end justify-center flex-col space-y-1`}>
            ...
            <div className={`${modalOpen === true ? "visible" : "invisible"
              ...
              <div className={`${modalOpen === true ? "opacity-100 mt-0 ease-in duration-300" : "opacity-0 mt-[100px]"
                ...
                <div className="w-full flex justify-center">
                  <button onClick={closeModal} className={`bg-btn4 w-fit py-[10px] px-6 flex items-center justify-center text-center rounded-[12px] font-medium text-[16px]`}>
                    Continue tasks
                  </button>
                </div>
              </div>
